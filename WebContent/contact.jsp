					...
					<div class="col-lg-6">
						<div class="contact_info">
							...
							<div class="contact_info_location">
								<div class="contact_info_location_title">Admin 1</div>
								<ul class="location_list">
									<li>L.J.I.E.T,Sarkhej,Ahmedabad,Gujarat,India</li>
									<li>+91-9898121214</li>
									<li>info.admissionmaster_1@gmail.com</li>
								</ul>
							</div>
							<div class="contact_info_location">
								<div class="contact_info_location_title">Admin 2</div>
								<ul class="location_list">
									<li>L.J.I.E.T,Sarkhej,Ahmedabad,Gujarat,India</li>
									<li>+91-9898121215</li>
									<li>info.admissionmaster_2@gmail.com</li>
								</ul>
							</div>
						</div>
					</div>
