						...
						<div class="row courses_row">
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="collegeDetails.jsp">L.J.I.E.T.</a></h3>
										<div class="course_teacher">Dr. A.C. Suthar</div>
									...
									<div class="course_footer">
										<div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
											<div class="course_info">
												...
												<span>10000+ Student</span>
											</div>
											<div class="course_info">
												<i class="fa fa-star" aria-hidden="true"></i>
												<span>5 Ratings</span>
											</div>
											<div class="course_price ml-auto">Anual fee</div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="collegeNirmaDetails.jsp">NIRMA</a></h3>
										<div class="course_teacher">Dr Anup K Singh</div>
										<div class="course_text">
											<p>Lorem ipsum dolor sit amet, consectetur adipi elitsed do eiusmod tempor</p>
										</div>
									</div>
